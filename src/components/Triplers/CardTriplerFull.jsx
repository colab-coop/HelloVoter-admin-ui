...
export const CardTriplerFull = props => (
  <div>
    ...
    <div>
      ...
      <Button onClick={() => props.refer._approveTripler(props.tripler, true)}>
        Approve
      </Button>
    </div>
        :
    ...
    <br />
    Address:
    <TriplerAddress global={global} refer={props.refer} tripler={props.tripler} />
    <br />
      {
        ...
        Object.keys(props.tripler.quiz_results).map((key) => {
          return <div key={key}><b>question:</b> {key} <b>answer:</b> {props.tripler.quiz_results[key]}<br /><br /></div>
        }) :
