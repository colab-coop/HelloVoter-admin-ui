...
const SERVER_URL = `${process.env.REACT_APP_PROTOCOL}://${process.env.REACT_APP_API_DOMAIN}/HelloVoterHQ/${process.env.REACT_APP_ORGID}/api/v1`;
...
class Login extends Component {
  constructor(props) {
    ...
    if (!process.env.REACT_APP_NO_AUTH)
      loginOptions = [
        { label: "Organization ID", value: "org" },
        { label: "3rd Party Server", value: "server" },
      ];
    if (process.env.NODE_ENV === "development")
      loginOptions.unshift({ label: "LOCAL DEVELOPMENT", value: "dev" });
    ...
    if (token) {
      ...
      setTimeout(() => {
        window.location.href =
          "/" + process.env.REACT_APP_SUBPATH + "/admin/#/";
      }, 500);
      setTimeout(() => {
  ...
  async apiLogIn(sm) {
    try {
      ...
      let smOauthUrl = `${res.headers.get("x-sm-oauth-url")}/${sm}/?aud=${
        process.env.REACT_APP_AUDIANCE
      }&app=${process.env.REACT_APP_KEY}`;
      if (process.env.NODE_ENV === "development")
      ...
      <main className={classes.main}>
        ...
        <Paper className={classes.paper}>
          ...
          <form
            ...
            onSubmit={(e) => {
              e.preventDefault();
              global.doSave(e, this.state.target);
            }}
          >
            <center>
              <br />
              ...
              <a
                ...
                href="https://raw.githubusercontent.com/OurVoiceUSA/HelloVoter/master/docs/Privacy-Policy.md"
              >
                Privacy Policy
              </a>
              &nbsp; || &nbsp;
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://raw.githubusercontent.com/OurVoiceUSA/HelloVoter/master/docs/Terms-of-Service.md"
              >
                Terms of Service
              </a>
              &nbsp; || &nbsp;
