...
import { notify_error, notify_success, _fetch } from "../common.js";
  ...
  render() {
    ...
    return (
      <main className={classes.main}>
        <CssBaseline />
        <button data-path="json-export/ambassadors" onClick={this.handleClick}>
          Ambassador JSON download
        </button>
        <br />
        <br />
        <button data-path="json-export/triplers" onClick={this.handleClick}>
          Tripler JSON download
        </button>
        <br />
        <br />
        <button data-path="csv-export/ambassadors" onClick={this.handleClick}>
          Ambassador CSV download
        </button>
        <br />
        <br />
        <button data-path="csv-export/triplers" onClick={this.handleClick}>
          Tripler CSV download
        </button>
        <br />
        <br />
        <br />
